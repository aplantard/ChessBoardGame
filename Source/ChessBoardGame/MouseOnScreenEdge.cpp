...
#include "MouseOnScreenEdge.h"
#include "Engine/World.h"

ETriggerState UMouseOnScreenEdge::UpdateState_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue ModifiedValue, float DeltaTime)
{
